...
export function createThreadParticipantData(userId: string, role = ParticipantRole.MEMBER) {
  return ThreadParticipantSchema.parse({ userId, role });
}

export function createThreadData(name: string, participants: Array<{ userId: string; role: ParticipantRole }>) {
...
export function createMessageData(userId: string, threadId: string, content: string) {
